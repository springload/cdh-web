...
class TestProject(TestCase):
    ...
    def test_excerpt(self):
        proj = Project(description='excerpt about the project',
            gen_description=False)
        # not autogenerated - description used
        assert proj.excerpt() == proj.description
        # autogenerated - nothing
        proj.gen_description = True
        assert not proj.excerpt()
        # autogenerated and tagline available
        proj.short_description = 'project tagline'
        assert proj.excerpt() == proj.short_description

...
class TestHomePage(WagtailPageTests):
    ...
    def test_can_create(self):
        ...
        self.assertCanCreateAt(Page, HomePage, nested_form_data({
            'title': 'Home 2',
            'slug': 'home-2',
            'body': streamfield([
...
class TestLandingPage(WagtailPageTests):
    ...
    def test_can_create(self):
        ...
        self.assertCanCreateAt(HomePage, LandingPage, nested_form_data({
            'title': 'Engage',
            'slug': 'engage',
...
class TestContentPage(WagtailPageTests):
    ...
    def test_can_create(self):
        ...
        self.assertCanCreateAt(LandingPage, ContentPage, nested_form_data({
            'title': 'Data Curation',
            'slug': 'data-curation',
            'body': streamfield([

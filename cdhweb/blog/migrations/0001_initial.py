    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured', models.BooleanField(default=False, help_text='Show the post in the carousel on the homepage.')),
                ...
                ('people', models.ManyToManyField(related_name='posts', through='blog.Author', to='people.Person')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='author',
            name='post',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='authors', to='blog.BlogPost'),
        ),
    ]

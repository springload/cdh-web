    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, help_text='Address of the location (will not display if same as name)', max_length=255, null=True)),
                ('is_virtual', models.BooleanField(default=False, help_text='Virtual platforms, i.e. Zoom or Google Hangouts', verbose_name='Virtual')),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='speakers', to='events.Event')),
